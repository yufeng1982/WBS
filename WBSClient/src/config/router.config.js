...
export const asyncRouterMap = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            meta: { title: 'menu.form.basic-form', keepAlive: true, permission: ['admin'] }
          },
          {
            path: '/form/step-form',
            name: 'StepForm',
      ...
      },
      {
        ...
        meta: { title: 'menu.article', icon: 'table' },
        children: [
          {
            path: '/article/article-list/:pageNo([1-9]\\d*)?',
            name: 'ArticleListWrapper',
            hideChildrenInMenu: true, // 强制显示 MenuItem 而不是 SubMenu
            component: () => import('@/views/article/ArtilceList'),
            meta: { title: 'menu.list.article-list', keepAlive: true }
          }
        ]
      }
      // list
